...
public class CadastroDeAcaoBean implements Serializable {
	...
	private ProcessoGenerico processoSelecionado;

	public void preRenderView() {
		if (acaoGenerica == null) {
			if (idDaAcao != null) {
				try {
					acaoGenerica = daoAcaoGenerica.buscar(Integer
							.parseInt(idDaAcao));
					processoSelecionado = acaoGenerica.getProcessoGenerico();
	...
	public String salvar() {
		try {
			...
			acaoGenerica.setProcessoGenerico(daoProcessoGenerico
					.buscar(processoSelecionado.getId()));
			if (cadastro) {
	...
	public void setProcessoSelecionado(ProcessoGenerico processoSelecionado) {
