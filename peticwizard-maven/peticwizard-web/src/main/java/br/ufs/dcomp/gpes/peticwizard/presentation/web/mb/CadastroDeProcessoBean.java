		...
		if (processo == null) {
			if (idDoProcesso != null) {
				try {
					...
					subareaSelecionada = processo.getSubarea();
					areaSelecionada = subareaSelecionada.getArea();
	...
	public String salvar() {
		try {
			...
			System.out.println("Subárea selecionada: "
					+ subareaSelecionada.getDescricao());
			processo.setSubarea(daoSubarea.buscar(subareaSelecionada.getId()));
			if (cadastro) {
